...
def main() -> None:
    ...
    if st.sidebar.button("AI and Fusion powered Economy"):
        st.session_state["topic"] = "AI and Fusion powered Economy"

    if st.sidebar.button("best value hotel in Paris"):
        st.session_state["topic"] = "best value hotel in Paris"

    if st.sidebar.button("General Theory of Relativity"):
        st.session_state["topic"] = "General Theory of Relativity"
